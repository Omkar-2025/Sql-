...
delete from bookings0_2009 where bookingId = 9;
...
insert into bookings0_2009 values(2, 3, getdate(), '2025-02-28', 3000);
...
--truncate table bookingService_2009;
...
insert into bookingService_2009 values(1, 3, 2, 400);
